...
export const HeroSection = () => {
  return (
    ...
    <div className='container flex  mx-auto px-6 lg:px-24'>
        <input type="text"  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter your dream description " required />

...
export const HeroSection = () => {
  return (
    <div className='flex flex-col justify-center items-center w-full bg-[url("./public/assets/hero-image.png")] py-6 h-[500px] bg-cover bg-center text-white' >  
    <h1 className='text-8xl font-semibold '>CEVISEZI.RO</h1>

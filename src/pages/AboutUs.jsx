...
export const AboutUs = () => {
  return (
    <>
      ...
      <Featured title="ABOUT US" url='bg-[url("./about-us.png")]' />
      ...
      <section className='container mx-auto px-6 lg:px-24 py-16 bg-white dark:bg-gray-900'>
        <div className=" px-4 mx-auto pb-10 lg:pb-18 max-w-screen-md">
          <h2 className=" text-5xl pb-6 tracking-tight font-extrabold text-center text-gray-900 dark:text-white">About Us</h2>
